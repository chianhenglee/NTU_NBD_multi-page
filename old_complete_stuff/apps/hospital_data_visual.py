...
#import hospital_data.get_bundle_id_name
from .hospital_data.get_bundle_id_name import get_bundle_id_name # my funciton to get cause name from bundle ids

# We're loading pickle files saved from data_aggregation of stata data
import pickle

# this is for getting app from index.py and app.py (only needed with multi-page app)
from app import app
...
## The following lines are not needed when in multi-page setup since we have these in the index page.
...
file_names = ['apps/hospital_data/data/ip105_i_processed.pickle',
			  'apps/hospital_data/data/ip105_p_processed.pickle',
			  'apps/hospital_data/data/oip105_i_processed.pickle',
			  'apps/hospital_data/data/oip105_p_processed.pickle']
...
id_name_dict = get_bundle_id_name('apps/hospital_data/bundle_to_cause_clinical.csv','bundle_id','cause_name')
