...
df = pd.read_csv('apps/lineplots_data/IHME_DALY_line_plot_data_try.csv')
#df = pd.read_csv('lineplots_data/IHME_DALY_line_plot_data_try.csv')
...
@app.callback(
    Output('my_graph_lineplots', 'figure'),
    [Input('submit-button_lineplots', 'n_clicks')],
